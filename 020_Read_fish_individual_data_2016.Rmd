...
year <- 2016
filename_save_rds <- "020_Fish_individual_data_2016.rds"
filename_save_csv <- "020_Fish_individual_data_2016.csv"
datafolder <- "data_input/Milkys_opparbeiding_fisk_2016/"
...
# delete this:  
sel <- fns %in% c("backup av MAL.xlsx", 
"Indre_oslofjord_MPB_torsk.xlsx", "MAL-FISK-stasjonskode_stasjonsnavn.xlsx")
fns <- fns[!sel]
